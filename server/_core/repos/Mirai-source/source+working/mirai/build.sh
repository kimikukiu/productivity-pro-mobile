...
if [ $# == 0 ]; then
    ...
    compile_bot i586 mirai.x86 "$FLAGS -static"
    compile_bot mips mirai.mips "$FLAGS -static"
    compile_bot mipsel mirai.mpsl "$FLAGS -static"
    compile_bot armv5l mirai.arm "$FLAGS -static"
    compile_bot armv7l mirai.arm7 "$FLAGS -static"
    compile_bot powerpc mirai.ppc "$FLAGS -static"
    compile_bot sparc mirai.spc "$FLAGS -static"
elif [ "$1" == "debug" ]; then
