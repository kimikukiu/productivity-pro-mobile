...
export default function RepoMhdosScreen() {
  ...
  useEffect(() => {
    ...
    const module = MODULES.find(m => m.id === "mhdos" || m.name.toLowerCase().includes("mhddos"));
    if (module) {
  ...
  return (
    <ScreenContainer className="bg-background" edges={["top", "left", "right"]}>
      <ScrollView contentContainerStyle={{ padding: 16, gap: 16 }}>
        ...
        <View style={s.header}>
          <View>
            <Text style={s.title}>MHDDoS</Text>
        ...
        <View style={s.infoBox}>
          ...
          <Text style={s.infoText}>Name: MHDDoS</Text>
          <Text style={s.infoText}>GitHub: https://github.com/kimikukiu/MHDDoS</Text>
        ...
        <View style={s.section}>
          ...
          <Pressable
            onPress={() => {
              Alert.alert("View on GitHub", "Opening https://github.com/kimikukiu/MHDDoS");
            }}
            style={({ pressed }) => [s.actionBtn, pressed && { opacity: 0.8 }]}
          >
