...
export default function RepoPayloadsScreen() {
  ...
  useEffect(() => {
    ...
    const module = MODULES.find(m => m.id === "payloads" || m.name.toLowerCase().includes("payloadsallthethings"));
    if (module) {
  ...
  return (
    <ScreenContainer className="bg-background" edges={["top", "left", "right"]}>
      <ScrollView contentContainerStyle={{ padding: 16, gap: 16 }}>
        ...
        <View style={s.header}>
          <View>
            <Text style={s.title}>PayloadsAllTheThings</Text>
        ...
        <View style={s.infoBox}>
          ...
          <Text style={s.infoText}>Name: PayloadsAllTheThings</Text>
          <Text style={s.infoText}>GitHub: https://github.com/kimikukiu/PayloadsAllTheThings</Text>
        ...
        <View style={s.section}>
          ...
          <Pressable
            onPress={() => {
              Alert.alert("View on GitHub", "Opening https://github.com/kimikukiu/PayloadsAllTheThings");
            }}
            style={({ pressed }) => [s.actionBtn, pressed && { opacity: 0.8 }]}
          >
