...
export default function RepoProjectWebScreen() {
  ...
  useEffect(() => {
    ...
    const module = MODULES.find(m => m.id === "project-web" || m.name.toLowerCase().includes("project-web"));
    if (module) {
  ...
  return (
    <ScreenContainer className="bg-background" edges={["top", "left", "right"]}>
      <ScrollView contentContainerStyle={{ padding: 16, gap: 16 }}>
        ...
        <View style={s.header}>
          <View>
            <Text style={s.title}>Project-web</Text>
        ...
        <View style={s.infoBox}>
          ...
          <Text style={s.infoText}>Name: Project-web</Text>
          <Text style={s.infoText}>GitHub: https://github.com/kimikukiu/Project-web</Text>
        ...
        <View style={s.section}>
          ...
          <Pressable
            onPress={() => {
              Alert.alert("View on GitHub", "Opening https://github.com/kimikukiu/Project-web");
            }}
            style={({ pressed }) => [s.actionBtn, pressed && { opacity: 0.8 }]}
          >
