...
export default function RepoAglStressScreen() {
  ...
  useEffect(() => {
    ...
    const module = MODULES.find(m => m.id === "agl-stress" || m.name.toLowerCase().includes("agl-stress"));
    if (module) {
  ...
  return (
    <ScreenContainer className="bg-background" edges={["top", "left", "right"]}>
      <ScrollView contentContainerStyle={{ padding: 16, gap: 16 }}>
        ...
        <View style={s.header}>
          <View>
            <Text style={s.title}>AGL-Stress</Text>
        ...
        <View style={s.infoBox}>
          ...
          <Text style={s.infoText}>Name: AGL-Stress</Text>
          <Text style={s.infoText}>GitHub: https://github.com/kimikukiu/AGL-Stress</Text>
        ...
        <View style={s.section}>
          ...
          <Pressable
            onPress={() => {
              Alert.alert("View on GitHub", "Opening https://github.com/kimikukiu/AGL-Stress");
            }}
            style={({ pressed }) => [s.actionBtn, pressed && { opacity: 0.8 }]}
          >
