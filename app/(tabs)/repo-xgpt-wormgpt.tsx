...
export default function RepoXgptWormgptScreen() {
  ...
  useEffect(() => {
    ...
    const module = MODULES.find(m => m.id === "xgpt-wormgpt" || m.name.toLowerCase().includes("xgpt-wormgpt"));
    if (module) {
  ...
  return (
    <ScreenContainer className="bg-background" edges={["top", "left", "right"]}>
      <ScrollView contentContainerStyle={{ padding: 16, gap: 16 }}>
        ...
        <View style={s.header}>
          <View>
            <Text style={s.title}>XGPT-WormGPT</Text>
        ...
        <View style={s.infoBox}>
          ...
          <Text style={s.infoText}>Name: XGPT-WormGPT</Text>
          <Text style={s.infoText}>GitHub: https://github.com/kimikukiu/XGPT-WormGPT</Text>
        ...
        <View style={s.section}>
          ...
          <Pressable
            onPress={() => {
              Alert.alert("View on GitHub", "Opening https://github.com/kimikukiu/XGPT-WormGPT");
            }}
            style={({ pressed }) => [s.actionBtn, pressed && { opacity: 0.8 }]}
          >
