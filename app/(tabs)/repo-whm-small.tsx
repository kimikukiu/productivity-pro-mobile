...
export default function RepoWhmSmallScreen() {
  ...
  useEffect(() => {
    ...
    const module = MODULES.find(m => m.id === "whm-small" || m.name.toLowerCase().includes("whm-small-pro"));
    if (module) {
  ...
  return (
    <ScreenContainer className="bg-background" edges={["top", "left", "right"]}>
      <ScrollView contentContainerStyle={{ padding: 16, gap: 16 }}>
        ...
        <View style={s.header}>
          <View>
            <Text style={s.title}>WHM-small-Pro</Text>
        ...
        <View style={s.infoBox}>
          ...
          <Text style={s.infoText}>Name: WHM-small-Pro</Text>
          <Text style={s.infoText}>GitHub: https://github.com/kimikukiu/WHM-small-Pro</Text>
        ...
        <View style={s.section}>
          ...
          <Pressable
            onPress={() => {
              Alert.alert("View on GitHub", "Opening https://github.com/kimikukiu/WHM-small-Pro");
            }}
            style={({ pressed }) => [s.actionBtn, pressed && { opacity: 0.8 }]}
          >
