...
export default function RepoSqlforceScreen() {
  ...
  useEffect(() => {
    ...
    const module = MODULES.find(m => m.id === "sqlforce" || m.name.toLowerCase().includes("sqlforce"));
    if (module) {
  ...
  return (
    <ScreenContainer className="bg-background" edges={["top", "left", "right"]}>
      <ScrollView contentContainerStyle={{ padding: 16, gap: 16 }}>
        ...
        <View style={s.header}>
          <View>
            <Text style={s.title}>sqlforce</Text>
        ...
        <View style={s.infoBox}>
          ...
          <Text style={s.infoText}>Name: sqlforce</Text>
          <Text style={s.infoText}>GitHub: https://github.com/kimikukiu/sqlforce</Text>
        ...
        <View style={s.section}>
          ...
          <Pressable
            onPress={() => {
              Alert.alert("View on GitHub", "Opening https://github.com/kimikukiu/sqlforce");
            }}
            style={({ pressed }) => [s.actionBtn, pressed && { opacity: 0.8 }]}
          >
