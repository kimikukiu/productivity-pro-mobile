...
export default function RepoWhmUn1cScreen() {
  ...
  useEffect(() => {
    ...
    const module = MODULES.find(m => m.id === "whm-un1c" || m.name.toLowerCase().includes("whm-un1c"));
    if (module) {
  ...
  return (
    <ScreenContainer className="bg-background" edges={["top", "left", "right"]}>
      <ScrollView contentContainerStyle={{ padding: 16, gap: 16 }}>
        ...
        <View style={s.header}>
          <View>
            <Text style={s.title}>whm-un1c</Text>
        ...
        <View style={s.infoBox}>
          ...
          <Text style={s.infoText}>Name: whm-un1c</Text>
          <Text style={s.infoText}>GitHub: https://github.com/kimikukiu/whm-un1c</Text>
        ...
        <View style={s.section}>
          ...
          <Pressable
            onPress={() => {
              Alert.alert("View on GitHub", "Opening https://github.com/kimikukiu/whm-un1c");
            }}
            style={({ pressed }) => [s.actionBtn, pressed && { opacity: 0.8 }]}
          >
