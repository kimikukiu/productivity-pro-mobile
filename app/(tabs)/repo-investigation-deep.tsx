...
export default function RepoInvestigationDeepScreen() {
  ...
  useEffect(() => {
    ...
    const module = MODULES.find(m => m.id === "investigation-deep" || m.name.toLowerCase().includes("investigation-deep-tools"));
    if (module) {
  ...
  return (
    <ScreenContainer className="bg-background" edges={["top", "left", "right"]}>
      <ScrollView contentContainerStyle={{ padding: 16, gap: 16 }}>
        ...
        <View style={s.header}>
          <View>
            <Text style={s.title}>investigation-deep-tools</Text>
        ...
        <View style={s.infoBox}>
          ...
          <Text style={s.infoText}>Name: investigation-deep-tools</Text>
          <Text style={s.infoText}>GitHub: https://github.com/kimikukiu/investigation-deep-tools</Text>
        ...
        <View style={s.section}>
          ...
          <Pressable
            onPress={() => {
              Alert.alert("View on GitHub", "Opening https://github.com/kimikukiu/investigation-deep-tools");
            }}
            style={({ pressed }) => [s.actionBtn, pressed && { opacity: 0.8 }]}
          >
