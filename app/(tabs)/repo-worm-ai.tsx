...
export default function RepoWormAiScreen() {
  ...
  useEffect(() => {
    ...
    const module = MODULES.find(m => m.id === "worm-ai" || m.name.toLowerCase().includes("worm-ai"));
    if (module) {
  ...
  return (
    <ScreenContainer className="bg-background" edges={["top", "left", "right"]}>
      <ScrollView contentContainerStyle={{ padding: 16, gap: 16 }}>
        ...
        <View style={s.header}>
          <View>
            <Text style={s.title}>worm-ai</Text>
        ...
        <View style={s.infoBox}>
          ...
          <Text style={s.infoText}>Name: worm-ai</Text>
          <Text style={s.infoText}>GitHub: https://github.com/kimikukiu/worm-ai</Text>
        ...
        <View style={s.section}>
          ...
          <Pressable
            onPress={() => {
              Alert.alert("View on GitHub", "Opening https://github.com/kimikukiu/worm-ai");
            }}
            style={({ pressed }) => [s.actionBtn, pressed && { opacity: 0.8 }]}
          >
