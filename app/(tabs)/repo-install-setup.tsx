...
export default function RepoInstallSetupScreen() {
  ...
  useEffect(() => {
    ...
    const module = MODULES.find(m => m.id === "install-setup" || m.name.toLowerCase().includes("install-setup"));
    if (module) {
  ...
  return (
    <ScreenContainer className="bg-background" edges={["top", "left", "right"]}>
      <ScrollView contentContainerStyle={{ padding: 16, gap: 16 }}>
        ...
        <View style={s.header}>
          <View>
            <Text style={s.title}>Install-setup</Text>
        ...
        <View style={s.infoBox}>
          ...
          <Text style={s.infoText}>Name: Install-setup</Text>
          <Text style={s.infoText}>GitHub: https://github.com/kimikukiu/Install-setup</Text>
        ...
        <View style={s.section}>
          ...
          <Pressable
            onPress={() => {
              Alert.alert("View on GitHub", "Opening https://github.com/kimikukiu/Install-setup");
            }}
            style={({ pressed }) => [s.actionBtn, pressed && { opacity: 0.8 }]}
          >
