...
export default function RepoW0rmGptScreen() {
  ...
  useEffect(() => {
    ...
    const module = MODULES.find(m => m.id === "w0rm-gpt" || m.name.toLowerCase().includes("w0rm-gpt"));
    if (module) {
  ...
  return (
    <ScreenContainer className="bg-background" edges={["top", "left", "right"]}>
      <ScrollView contentContainerStyle={{ padding: 16, gap: 16 }}>
        ...
        <View style={s.header}>
          <View>
            <Text style={s.title}>W0rm-Gpt</Text>
        ...
        <View style={s.infoBox}>
          ...
          <Text style={s.infoText}>Name: W0rm-Gpt</Text>
          <Text style={s.infoText}>GitHub: https://github.com/kimikukiu/W0rm-Gpt</Text>
        ...
        <View style={s.section}>
          ...
          <Pressable
            onPress={() => {
              Alert.alert("View on GitHub", "Opening https://github.com/kimikukiu/W0rm-Gpt");
            }}
            style={({ pressed }) => [s.actionBtn, pressed && { opacity: 0.8 }]}
          >
