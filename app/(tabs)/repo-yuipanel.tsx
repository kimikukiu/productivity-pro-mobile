...
export default function RepoYuipanelScreen() {
  ...
  useEffect(() => {
    ...
    const module = MODULES.find(m => m.id === "yuipanel" || m.name.toLowerCase().includes("yuipanel_ir"));
    if (module) {
  ...
  return (
    <ScreenContainer className="bg-background" edges={["top", "left", "right"]}>
      <ScrollView contentContainerStyle={{ padding: 16, gap: 16 }}>
        ...
        <View style={s.header}>
          <View>
            <Text style={s.title}>YuiPanel_ir</Text>
        ...
        <View style={s.infoBox}>
          ...
          <Text style={s.infoText}>Name: YuiPanel_ir</Text>
          <Text style={s.infoText}>GitHub: https://github.com/kimikukiu/YuiPanel_ir</Text>
        ...
        <View style={s.section}>
          ...
          <Pressable
            onPress={() => {
              Alert.alert("View on GitHub", "Opening https://github.com/kimikukiu/YuiPanel_ir");
            }}
            style={({ pressed }) => [s.actionBtn, pressed && { opacity: 0.8 }]}
          >
