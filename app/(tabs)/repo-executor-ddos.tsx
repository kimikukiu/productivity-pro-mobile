...
export default function RepoExecutorDdosScreen() {
  ...
  useEffect(() => {
    ...
    const module = MODULES.find(m => m.id === "executor-ddos" || m.name.toLowerCase().includes("executor-ddos"));
    if (module) {
  ...
  return (
    <ScreenContainer className="bg-background" edges={["top", "left", "right"]}>
      <ScrollView contentContainerStyle={{ padding: 16, gap: 16 }}>
        ...
        <View style={s.header}>
          <View>
            <Text style={s.title}>EXECUTOR-DDOS</Text>
        ...
        <View style={s.infoBox}>
          ...
          <Text style={s.infoText}>Name: EXECUTOR-DDOS</Text>
          <Text style={s.infoText}>GitHub: https://github.com/kimikukiu/EXECUTOR-DDOS</Text>
        ...
        <View style={s.section}>
          ...
          <Pressable
            onPress={() => {
              Alert.alert("View on GitHub", "Opening https://github.com/kimikukiu/EXECUTOR-DDOS");
            }}
            style={({ pressed }) => [s.actionBtn, pressed && { opacity: 0.8 }]}
          >
