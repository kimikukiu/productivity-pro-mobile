...
export default function RepoIdsInfScreen() {
  ...
  useEffect(() => {
    ...
    const module = MODULES.find(m => m.id === "ids-inf" || m.name.toLowerCase().includes("ids-inf"));
    if (module) {
  ...
  return (
    <ScreenContainer className="bg-background" edges={["top", "left", "right"]}>
      <ScrollView contentContainerStyle={{ padding: 16, gap: 16 }}>
        ...
        <View style={s.header}>
          <View>
            <Text style={s.title}>ids-inf</Text>
        ...
        <View style={s.infoBox}>
          ...
          <Text style={s.infoText}>Name: ids-inf</Text>
          <Text style={s.infoText}>GitHub: https://github.com/kimikukiu/ids-inf</Text>
        ...
        <View style={s.section}>
          ...
          <Pressable
            onPress={() => {
              Alert.alert("View on GitHub", "Opening https://github.com/kimikukiu/ids-inf");
            }}
            style={({ pressed }) => [s.actionBtn, pressed && { opacity: 0.8 }]}
          >
