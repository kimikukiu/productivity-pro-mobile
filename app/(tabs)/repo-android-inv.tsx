...
export default function RepoAndroidInvScreen() {
  ...
  useEffect(() => {
    ...
    const module = MODULES.find(m => m.id === "android-inv" || m.name.toLowerCase().includes("android-investigation-core"));
    if (module) {
  ...
  return (
    <ScreenContainer className="bg-background" edges={["top", "left", "right"]}>
      <ScrollView contentContainerStyle={{ padding: 16, gap: 16 }}>
        ...
        <View style={s.header}>
          <View>
            <Text style={s.title}>android-investigation-core</Text>
        ...
        <View style={s.infoBox}>
          ...
          <Text style={s.infoText}>Name: android-investigation-core</Text>
          <Text style={s.infoText}>GitHub: https://github.com/kimikukiu/android-investigation-core</Text>
        ...
        <View style={s.section}>
          ...
          <Pressable
            onPress={() => {
              Alert.alert("View on GitHub", "Opening https://github.com/kimikukiu/android-investigation-core");
            }}
            style={({ pressed }) => [s.actionBtn, pressed && { opacity: 0.8 }]}
          >
