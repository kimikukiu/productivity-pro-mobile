...
export default function RepoHexstrikeAiScreen() {
  ...
  useEffect(() => {
    ...
    const module = MODULES.find(m => m.id === "hexstrike-ai" || m.name.toLowerCase().includes("hexstrike-ai"));
    if (module) {
  ...
  return (
    <ScreenContainer className="bg-background" edges={["top", "left", "right"]}>
      <ScrollView contentContainerStyle={{ padding: 16, gap: 16 }}>
        ...
        <View style={s.header}>
          <View>
            <Text style={s.title}>Hexstrike-AI</Text>
        ...
        <View style={s.infoBox}>
          ...
          <Text style={s.infoText}>Name: Hexstrike-AI</Text>
          <Text style={s.infoText}>GitHub: https://github.com/havij13/Hexstrike-AI</Text>
        ...
        <View style={s.section}>
          ...
          <Pressable
            onPress={() => {
              Alert.alert("View on GitHub", "Opening https://github.com/havij13/Hexstrike-AI");
            }}
            style={({ pressed }) => [s.actionBtn, pressed && { opacity: 0.8 }]}
          >
