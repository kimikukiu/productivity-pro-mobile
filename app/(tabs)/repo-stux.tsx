...
export default function RepoStuxScreen() {
  ...
  useEffect(() => {
    ...
    const module = MODULES.find(m => m.id === "stux" || m.name.toLowerCase().includes("stuxwhoamisec"));
    if (module) {
  ...
  return (
    <ScreenContainer className="bg-background" edges={["top", "left", "right"]}>
      <ScrollView contentContainerStyle={{ padding: 16, gap: 16 }}>
        ...
        <View style={s.header}>
          <View>
            <Text style={s.title}>StuxWhoamisec</Text>
        ...
        <View style={s.infoBox}>
          ...
          <Text style={s.infoText}>Name: StuxWhoamisec</Text>
          <Text style={s.infoText}>GitHub: https://github.com/kimikukiu/StuxWhoamisec</Text>
        ...
        <View style={s.section}>
          ...
          <Pressable
            onPress={() => {
              Alert.alert("View on GitHub", "Opening https://github.com/kimikukiu/StuxWhoamisec");
            }}
            style={({ pressed }) => [s.actionBtn, pressed && { opacity: 0.8 }]}
          >
