...
export default function RepoInvestigationCoreAiScreen() {
  ...
  useEffect(() => {
    ...
    const module = MODULES.find(m => m.id === "investigation-core-ai" || m.name.toLowerCase().includes("investigation-core-ai-system"));
    if (module) {
  ...
  return (
    <ScreenContainer className="bg-background" edges={["top", "left", "right"]}>
      <ScrollView contentContainerStyle={{ padding: 16, gap: 16 }}>
        ...
        <View style={s.header}>
          <View>
            <Text style={s.title}>investigation-core-ai-system</Text>
        ...
        <View style={s.infoBox}>
          ...
          <Text style={s.infoText}>Name: investigation-core-ai-system</Text>
          <Text style={s.infoText}>GitHub: https://github.com/kimikukiu/investigation-core-ai-system</Text>
        ...
        <View style={s.section}>
          ...
          <Pressable
            onPress={() => {
              Alert.alert("View on GitHub", "Opening https://github.com/kimikukiu/investigation-core-ai-system");
            }}
            style={({ pressed }) => [s.actionBtn, pressed && { opacity: 0.8 }]}
          >
