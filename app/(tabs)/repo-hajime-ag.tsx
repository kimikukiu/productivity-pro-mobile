...
export default function RepoHajimeAgScreen() {
  ...
  useEffect(() => {
    ...
    const module = MODULES.find(m => m.id === "hajime-ag" || m.name.toLowerCase().includes("hajime-ag"));
    if (module) {
  ...
  return (
    <ScreenContainer className="bg-background" edges={["top", "left", "right"]}>
      <ScrollView contentContainerStyle={{ padding: 16, gap: 16 }}>
        ...
        <View style={s.header}>
          <View>
            <Text style={s.title}>Hajime-AG</Text>
        ...
        <View style={s.infoBox}>
          ...
          <Text style={s.infoText}>Name: Hajime-AG</Text>
          <Text style={s.infoText}>GitHub: https://github.com/kimikukiu/Hajime-AG</Text>
        ...
        <View style={s.section}>
          ...
          <Pressable
            onPress={() => {
              Alert.alert("View on GitHub", "Opening https://github.com/kimikukiu/Hajime-AG");
            }}
            style={({ pressed }) => [s.actionBtn, pressed && { opacity: 0.8 }]}
          >
