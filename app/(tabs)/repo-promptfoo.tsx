...
export default function RepoPromptfooScreen() {
  ...
  useEffect(() => {
    ...
    const module = MODULES.find(m => m.id === "promptfoo" || m.name.toLowerCase().includes("promptfoo"));
    if (module) {
  ...
  return (
    <ScreenContainer className="bg-background" edges={["top", "left", "right"]}>
      <ScrollView contentContainerStyle={{ padding: 16, gap: 16 }}>
        ...
        <View style={s.header}>
          <View>
            <Text style={s.title}>promptfoo</Text>
        ...
        <View style={s.infoBox}>
          ...
          <Text style={s.infoText}>Name: promptfoo</Text>
          <Text style={s.infoText}>GitHub: https://github.com/kimikukiu/promptfoo</Text>
        ...
        <View style={s.section}>
          ...
          <Pressable
            onPress={() => {
              Alert.alert("View on GitHub", "Opening https://github.com/kimikukiu/promptfoo");
            }}
            style={({ pressed }) => [s.actionBtn, pressed && { opacity: 0.8 }]}
          >
