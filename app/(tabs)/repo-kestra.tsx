...
export default function RepoKestraScreen() {
  ...
  useEffect(() => {
    ...
    const module = MODULES.find(m => m.id === "kestra" || m.name.toLowerCase().includes("kestra"));
    if (module) {
  ...
  return (
    <ScreenContainer className="bg-background" edges={["top", "left", "right"]}>
      <ScrollView contentContainerStyle={{ padding: 16, gap: 16 }}>
        ...
        <View style={s.header}>
          <View>
            <Text style={s.title}>kestra</Text>
        ...
        <View style={s.infoBox}>
          ...
          <Text style={s.infoText}>Name: kestra</Text>
          <Text style={s.infoText}>GitHub: https://github.com/kimikukiu/kestra</Text>
        ...
        <View style={s.section}>
          ...
          <Pressable
            onPress={() => {
              Alert.alert("View on GitHub", "Opening https://github.com/kimikukiu/kestra");
            }}
            style={({ pressed }) => [s.actionBtn, pressed && { opacity: 0.8 }]}
          >
