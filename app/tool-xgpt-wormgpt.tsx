...
export default function XGPTWormGPTToolPanel() {
  ...
  return (
    <ScreenContainer edges={["top", "left", "right"]} containerClassName="bg-background">
      <View style={styles.header}>
        ...
        <Text style={[styles.title, { color: colors.foreground }]}>XGPT-WormGPT</Text>
      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: 16 }}>
        ...
        <View style={[styles.inputGroup, { marginTop: 12 }]}>
          ...
          <View style={[styles.inputBox, { backgroundColor: colors.surface, borderColor: colors.border }]}>
            <TextInput
              ...
              style={{ color: colors.foreground, fontFamily: "monospace", fontSize: 13, padding: 12 }}
              multiline
            />
          </View>
        </View>
        ...
        <Pressable
          style={({ pressed }) => [styles.executeBtn, pressed && { opacity: 0.7 }]}
        >
